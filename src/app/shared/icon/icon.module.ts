...
import { IconCursorSquareComponent } from "src/app/shared/icon/icon-cursor-square";
import { IconPhoneCallCancelComponent } from "./icon-phone-call-cancel";
import { IconMuteComponent } from "./icon-mute";
...
@NgModule({
  ...
  declarations: [
    ...
    IconCursorSquareComponent,
    IconPhoneCallCancelComponent,
    IconMuteComponent,
  ],
  exports: [
    IconMenuAppsComponent,
