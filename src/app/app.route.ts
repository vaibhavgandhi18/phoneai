...
export const routes: Routes = [
    {
        ...
        children: [
            ...
            { path: 'user-bot-playground', component: PlaygroundComponent, title: 'User Bot Playground' },
            { path: 'service-bot-playground', component: ServicePlaygroundComponent, title: 'Service Bot Playground' },
